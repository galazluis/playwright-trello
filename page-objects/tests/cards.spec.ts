...
test.describe('Cards front-end feature testing', () => {
    ...
    test('As a user, I should be able to add a new card to the To Do list', async ({browserName}) => {
    ...
    test('As a user, I should be able to add a new card to the Doing list', async ({browserName}) => {
